...
import com.gongdan.common.exception.DataValidationException;
import com.gongdan.common.support.Messages.MessageHolder;
...
public class ValidationAssert {
	...
	public static void isTrue(boolean expression, MessageHolder messageHolder) {
		if (!expression) {
			throw new DataValidationException(messageHolder.getMessage());
		}
	}
	...
	public static void isInstanceOf(Class<?> type, Object obj) {
		...
		if (!type.isInstance(obj)) {
			throw new DataValidationException("Object of class [" + (obj != null ? obj.getClass().getName() : "null") +"] must be an instance of " + type);
		}
	}
	...
	public static void isAssignable(Class<?> superType, Class<?> subType) {
		...
		if (subType == null || !superType.isAssignableFrom(subType)) {
			throw new DataValidationException(subType + " is not assignable to " + superType);
		}
	}
