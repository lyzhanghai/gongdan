...
<body>
	<div class="uk-container">
		<div class="uk-location">
			<ul class="uk-breadcrumb">
			  ...
			  <li class="active">新增自动回复</li>
			</ul>
		</div>
		<form id="messageReplyAddForm" class="uk-form" name="messageReplyAddForm" action="${CONTEXT_PATH}/admin/weixin/messagereply/add/submit" method="post">
			<input type="hidden" name="token" value="${token}"/>
			<fieldset>
				<legend>新增自动回复</legend>
				<div>
					<div class="uk-form-row">
						<div class="uk-form-label uk-width-1-5"><em>*</em><label for="keyword">匹配关键字：</label></div>
						<div class="uk-form-field uk-width-2-5">
							<input type="text" name="keyword" maxlength="50" value="${messageReplyAddForm.keyword}"/>
						</div>
						...
						<div class="uk-form-field uk-width-2-5">
							<select name="matchMode">
								...
								<c:forEach items="${matchModes}" var="item">
									<option value="${item.modeCode}" ${messageReplyAddForm.matchMode eq item.modeCode ? 'selected' : ''}>${item.modeName}</option>
								</c:forEach>
							</select>
						</div>
						<div class="uk-form-info uk-width-2-5">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-field uk-width-2-5">
							<input type="text" name="msgId" maxlength="10" value="${messageReplyAddForm.msgId}"/>
						</div>
						<div class="uk-form-info uk-width-2-5">
    ...
    <script type="text/javascript" src="${CONTEXT_PATH}/resources/scripts/admin/weixin/messagereply/add.js"></script>
</body>
</html>