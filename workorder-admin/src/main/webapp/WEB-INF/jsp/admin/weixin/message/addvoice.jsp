...
<head>
	...
	<style type="text/css">
    	.xupload-list-message-voice .xupload-box > a, .xupload-list-message-voice .xupload-box > a.xupload-uploading, .xupload-list-message-voice .xupload-box > a.xupload-error { width: 200px;height: 200px; }
    	.xupload-list-message-voice .xupload-box > a > img { width: 100px;height: 100px; margin: 30px 50px;}
...
<body>
	<div class="uk-container">
		...
		<form id="messageAddForm" class="uk-form" name="messageAddForm" action="${CONTEXT_PATH}/admin/weixin/message/addvoice/submit" method="post">
			...
			<fieldset data-uk-margin>
				...
				<div>
					...
					<div class="message-item">
						<div class="uk-form-row">
							<div class="uk-form-label uk-width-1-5"><em>*</em><label for="mediaUrl">上传语音：</label></div>
							<div class="uk-form-field uk-width-2-5">
								<input id="mediaUrl" type="hidden" name="mediaUrl"/>
								<div class="xupload-list xupload-list-message-voice" style="display:block;"></div>
							...
							<div class="uk-form-info uk-width-2-5">
								<div class="uk-validate-message uk-validate-message-tips" for="mediaUrl">
									<em class="uk-validate-message-icon"></em><span class="uk-validate-message-text">语音文件限5M以内,时长不超过60秒(支持mp3/wma/wav/amr)</span>
								</div>
							</div>
						</div>
					</div>
	...
	<form id="fileUploadForm" action="${CONTEXT_PATH}/xupload/file/submit" method="post" enctype="multipart/form-data" style="display:none;">
		<input type="hidden" name="uploadSerialNo"/>
		<input type="hidden" name="maxFileSize" value="5242880"/>
	</form>
    ...
    <script type="text/javascript" src="${CONTEXT_PATH}/resources/scripts/admin/weixin/message/addvoice.js"></script>
</body>
</html>