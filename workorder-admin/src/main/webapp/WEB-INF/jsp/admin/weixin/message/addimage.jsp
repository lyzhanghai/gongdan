...
<body>
	<div class="uk-container">
		...
		<form id="messageAddForm" class="uk-form" name="messageAddForm" action="${CONTEXT_PATH}/admin/weixin/message/addimage/submit" method="post">
			...
			<fieldset data-uk-margin>
				...
				<div>
					...
					<div class="message-item">
						<div class="uk-form-row">
							<div class="uk-form-label uk-width-1-5"><em>*</em><label for="mediaUrl">上传图片：</label></div>
							<div class="uk-form-field uk-width-2-5">
								<input id="mediaUrl" type="hidden" name="mediaUrl"/>
								<div class="xupload-list xupload-list-message-image" style="display:block;"></div>
    ...
    <script type="text/javascript" src="${CONTEXT_PATH}/resources/scripts/admin/weixin/message/addimage.js"></script>
</body>
</html>