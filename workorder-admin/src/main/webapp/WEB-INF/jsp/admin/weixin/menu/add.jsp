...
<body>
	<div class="uk-container">
		...
		<form id="menuAddForm" class="uk-form" name="menuAddForm" action="${CONTEXT_PATH}/admin/weixin/menu/add/submit" method="post">
				...
				<div>
					<div class="uk-form-row">
						...
						<div class="uk-form-field uk-width-2-5">
							<input type="hidden" name="parentMenuId" value="${menuAddForm.parentMenuId}"/>
							<input type="text" name="parentMenuName" readonly="readonly" value="${menuAddForm.parentMenuName}"/>
						</div>
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-field uk-width-2-5">
							<input type="text" name="menuName" maxlength="20" value="${menuAddForm.menuName}"/>
						</div>
						<div class="uk-form-info uk-width-2-5">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-field uk-width-2-5">
							<input type="text" name="menuUrl" maxlength="500" value="${menuAddForm.menuUrl}"/>
						</div>
						<div class="uk-form-info uk-width-2-5">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-field uk-width-2-5">
							<input type="text" name="siblingsIndex" maxlength="10" value="${menuAddForm.siblingsIndex}"/>
						</div>
						<div class="uk-form-info uk-width-2-5">
    ...
    <script type="text/javascript" src="${CONTEXT_PATH}/resources/scripts/admin/weixin/menu/add.js"></script>
</body>
</html>