...
<head>
	...
	<style type="text/css">
    	.xupload-list-message-video .xupload-box > a, .xupload-list-message-video .xupload-box > a.xupload-uploading, .xupload-list-message-video .xupload-box > a.xupload-error { width: 200px;height: 200px; }
    	.xupload-list-message-video .xupload-box > a > img { width: 100px;height: 100px; margin: 30px 50px;}
...
<body>
	<div class="uk-container">
		...
		<form id="messageAddForm" class="uk-form" name="messageAddForm" action="${CONTEXT_PATH}/admin/weixin/message/addvideo/submit" method="post">
			...
			<fieldset data-uk-margin>
				...
				<div>
					...
					<div class="message-item">
						...
						<div class="uk-form-row">
							<div class="uk-form-label uk-width-1-5"><em>*</em><label for="mediaUrl">上传视频：</label></div>
							<div class="uk-form-field uk-width-2-5">
								<input id="mediaUrl" type="hidden" name="mediaUrl"/>
								<div class="xupload-list xupload-list-message-video" style="display:block;"></div>
							...
							<div class="uk-form-info uk-width-2-5">
								<div class="uk-validate-message uk-validate-message-tips" for="mediaUrl">
									<em class="uk-validate-message-icon"></em><span class="uk-validate-message-text">视频文件限10M以内(仅支持mp4格式)</span>
								</div>
							</div>
						</div>
					</div>
	...
	<form id="fileUploadForm" action="${CONTEXT_PATH}/xupload/file/submit" method="post" enctype="multipart/form-data" style="display:none;">
		...
		<input type="hidden" name="maxFileSize" value="10485760"/>
	</form>
    ...
    <script type="text/javascript" src="${CONTEXT_PATH}/resources/scripts/admin/weixin/message/addvideo.js"></script>
</body>
</html>