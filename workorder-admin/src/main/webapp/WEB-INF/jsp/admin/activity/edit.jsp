...
<div class="uk-container">
    ...
    <form id="activityEditForm" class="uk-form" name="activityEditForm" action="${CONTEXT_PATH}/admin/activity/edit/submit" method="post">
        <fieldset>
            <legend>修改活动</legend>
            <div>
                <div class="uk-form-row uk-form-row-width">
                    ...
                    <div class="uk-form-field uk-width-7-10">
                    	<input type="hidden" name="id" value="${activityEditForm.id}"/>
                        <input type="text" name="title" value="${activityEditForm.title}" maxlength="13"/>
                    </div>
                ...
                <div class="uk-form-row">
                    <div class="uk-form-label uk-width-1-10"><em>*</em><label for="imgUri">活动缩略图片：</label></div>
                    <div class="uk-form-field uk-width-7-10">
                        <input id="thumbnail" type="hidden" name="thumbnail" value="${activityEditForm.thumbnail}"/>
                        <input id="fullThumbnail" type="hidden" name="fullThumbnail" value="${activityEditForm.fullThumbnail}"/>
                    ...
                    <div class="uk-form-info uk-width-2-10">
                        <div class="uk-validate-message uk-validate-message-tips" for="imgUri">
                            <em class="uk-validate-message-icon"></em><span class="uk-validate-message-text">图片限1M以内,支持jpg/png/gif,缩略图尺寸164x224</span>
                        </div>
                    </div>
                </div>
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-field uk-width-7-10">
                        <input id="imgUri" type="hidden" name="imgUri" value="${activityEditForm.imgUri}"/>
                        <input id="fullImgUri" type="hidden" name="fullImgUri" value="${activityEditForm.fullImgUri}"/>
                    ...
                    <div class="uk-form-info uk-width-2-10">
                        <div class="uk-validate-message uk-validate-message-tips" for="imgUri">
                            <em class="uk-validate-message-icon"></em><span class="uk-validate-message-text">图片限1M以内,支持jpg/png/gif,大图尺寸 750x360</span>
                        </div>
                    </div>
                </div>
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-field uk-width-7-10">
                        <input type="text" id="startTime" name="startTime" maxlength="20" value="${activityEditForm.startTime}"/>
                    </div>
                    <div class="uk-form-info uk-width-2-10">
                  ...
                  <div class="uk-form-row">
                    ...
                    <div class="uk-form-field uk-width-7-10">
                        <input type="text" id="endTime" name="endTime" maxlength="20" value="${activityEditForm.endTime}"/>
                    </div>
                    <div class="uk-form-info uk-width-2-10">
                ...
                <c:if test="${activityEditForm.type ne 4}">
              <div class="uk-form-row">
                    <div class="uk-form-label uk-width-1-10"><em>*</em><label for="endTime">取消活动截止时间</label>：</div>
                    <div class="uk-form-field uk-width-7-10">
                        <input type="text" id="cancelTime" name="cancelTime" maxlength="20" value="${activityEditForm.cancelTime}"/>
                    </div>
                    <div class="uk-form-info uk-width-2-10">
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-field uk-width-7-10">
                        <input type="text" name="place" maxlength="20" value="${activityEditForm.place}"/>
                    </div>
                    <div class="uk-form-info uk-width-2-10">
               ...
               <div class="uk-form-row">
                    ...
                    <div class="uk-form-field uk-width-7-10">
                        <input type="text" name="traffic"maxlength="30" value="${activityEditForm.traffic}"/>
                    </div>
                    <div class="uk-form-info uk-width-2-10">
                 ...
                 <div class="uk-form-row">
                    <div class="uk-form-label uk-width-1-10"><em>*</em><label for="traffic">活动简介</label>：</div>
                    <div class="uk-form-field uk-width-7-10">
                        <input type="text" name="decription" maxlength="50" value="${activityEditForm.decription}"/>
                    </div>
                    <div class="uk-form-info uk-width-2-10">
                        <div class="uk-validate-message uk-validate-message-tips" for="traffic">
                            <em class="uk-validate-message-icon"></em><span class="uk-validate-message-text"></span>
                ...
                <div class="uk-form-row">
                    <div class="uk-form-label uk-width-1-10"><em>*</em><label for="intro">活动介绍：</label></div>
                    <div class="uk-form-field uk-width-7-10">
                    	<textarea id="intro" rows="3" name="intro">${activityEditForm.intro}</textarea>
                    </div>
                    <div class="uk-form-info uk-width-2-10">
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-field uk-width-7-10">
                    	<input id="type" type="hidden" name="type" value="${activityEditForm.type}"/>
						<label class="uk-font-bold">${activityEditForm.typeName}</label>
                    </div>
                    <div class="uk-form-info uk-width-2-10">
                        <div class="uk-validate-message uk-validate-message-tips" for="type">
                            <em class="uk-validate-message-icon"></em><span class="uk-validate-message-text">活动信息创建后,活动类型就不允许更改了!</span>
                        </div>
                    </div>
                </div>
                <c:if test="${activityEditForm.type eq 1}">
                   <div class="uk-form-row">
	                    <div class="uk-form-label uk-width-1-10"><em>*</em><label for="lecturer">讲师名称：</label></div>
	                    <div class="uk-form-field uk-width-7-10">
	                        <input type="text" id="lecturer" name="lecturer" maxlength="20" value="${activityEditForm.lecturer}"/>
	                    </div>
	                    <div class="uk-form-info uk-width-2-10">
	                ...
	                <div class="uk-form-row">
	                    ...
	                    <div class="uk-form-field uk-width-7-10">
	                    	<textarea rows="3" id="lecturerIntro" name="lecturerIntro" maxlength="100">${activityEditForm.lecturerIntro}</textarea>
	                    </div>
	                    <div class="uk-form-info uk-width-2-10">
                ...
                <div class="activity-extra" style="display:none;" data-activity-type="${applicationScope.ACTIVITY_TYPE_FORUM_SELECT_SEAT.typeCode}">
                	<div class="uk-form-row">
	                    ...
	                    <div class="uk-form-field uk-width-7-10">
	                        <input type="text" id="selectSeatStartTime" name="selectSeatStartTime" maxlength="20" value="${activityEditForm.selectSeatStartTime}"/>
	                    </div>
	                    <div class="uk-form-info uk-width-2-10">
	                ...
	                <div class="uk-form-row">
	                    ...
	                    <div class="uk-form-field uk-width-7-10">
	                        <input type="text" id="selectSeatEndTime" name="selectSeatEndTime" maxlength="20" value="${activityEditForm.selectSeatEndTime}"/>
	                    </div>
	                    <div class="uk-form-info uk-width-2-10">
	                    ...
	                    <div class="uk-form-field uk-width-7-10">
	                        <div class="uk-grid">
	                        	<div class="uk-width-1-2">
	                        		<label>总行数：<input id="rows" class="uk-w40" type="text" name="rows" value="${activityEditForm.rows}"/></label>
	                        		<label>总列数：<input id="cols" class="uk-w40" type="text" name="cols" value="${activityEditForm.cols}"/></label>
	                        	</div>
	                        	<div class="uk-width-1-2">
	                	...
	                	<div class="uk-width-1-1">
	                		<div class="uk-table-scroll-container" data-relative-target=".uk-form-row-width">
	                        	<table class="uk-table uk-table-fixed uk-table-hover uk-table-seats" cellspacing="0" width="100%">
	                        		...
	                        		<thead>
		                       			<tr>
		                       				<c:forEach begin="1" end="${activityEditForm.cols}" var="idx">
		                       					<th>${idx}</th>
		                       				</c:forEach>
		                       			</tr>
		                       		</thead>
		                       		<tbody>
		                       			<tr>
		                       				<c:forEach items="${activityEditForm.activitySeatList}" var="item" varStatus="stat">
			                       				<td><div class="seat-box seat-box-${item.status}"><input type="text" name="status" value="${item.status}" onblur="onSeatStatusBlur(this);"/></div></td>
			                       				<c:if test="${item.col eq activityEditForm.cols}">
			                       					</tr><tr>
			                       				</c:if>
		                       				</c:forEach>
		                       			</tr>
...
<script type="text/javascript" src="${CONTEXT_PATH}/resources/scripts/admin/activity/edit.js"></script>
