...
<div class="uk-container">
    ...
    <form id="bannerAddForm" class="uk-form" name="bannerAddForm" action="${CONTEXT_PATH}/admin/banner/add/submit" method="post">
        <fieldset>
            ...
            <div>
                <div class="uk-form-row uk-form-row-width">
                    ...
                    <div class="uk-form-field uk-width-6-10">
                        <input type="text" name="title" value="${bannerAddForm.title}" maxlength="100"/>
                    </div>
                ...
                <div class="uk-form-row" id="bannerDiv">
                    ...
                    <div class="uk-form-field uk-width-6-10">
                        <input type="text" name="linkUrl" value="${bannerAddForm.linkUrl}" maxlength="255"/>
                    </div>
                    <div class="uk-form-info uk-width-2-10">
                    ...
                    <div class="uk-form-field uk-width-6-10">
                        <select name="type"  onchange="getUrl(this)">
							...
							<c:forEach items="${types}" var="item">
								<option value="${item.typeCode}" ${bannerAddForm.type eq item.typeCode ? 'selected' : ''}>${item.typeName}</option>
							</c:forEach>
						</select>
                    </div>
                    <div class="uk-form-info uk-width-2-10">
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-field uk-width-6-10">
                        <input type="text" name="typeIndex" maxlength="11" value="${bannerAddForm.typeIndex != null ? bannerAddForm.typeIndex : '0'}"/>
                    </div>
                    <div class="uk-form-info uk-width-2-10">
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-field uk-width-6-10">
                       	<textarea rows="3" name="remark" maxlength="500">${bannerAddForm.remark}</textarea>
                    </div>
                    <div class="uk-form-info uk-width-2-10">
...
<script type="text/javascript" src="${CONTEXT_PATH}/resources/scripts/admin/banner/add.js"></script>
</body>
</html>