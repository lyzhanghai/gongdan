...
<div class="uk-container">
    <div class="uk-location">
        <ul class="uk-breadcrumb">
            ...
            <li class="active">新增文化动态</li>
        </ul>
    </div>
    <form id="cultureAddForm" class="uk-form" name="cultureAddForm" action="${CONTEXT_PATH}/admin/culture/add" method="post">
        <fieldset>
            <legend>新增文化动态</legend>
            <div>
<!--                 <div class="uk-form-row"> -->
<!--                     <div class="uk-form-label uk-width-2-10"><label for="orderNum">排序</label>：</div> -->
<!--                     <div class="uk-form-field uk-width-6-10"> -->
<!--                         <input type="text" name="orderNum" maxlength="11" /> -->
<!--                     </div> -->
...
<!--                 </div> -->
                <div class="uk-form-row uk-form-row-width">
                    <div class="uk-form-label uk-width-2-10"><em>*</em><label for="name">主题文化标题</label>：</div>
                    <div class="uk-form-field uk-width-6-10">
                        <input type="text" name="name" value="${culture.name}" maxlength="20"/>
                    </div>
                    <div class="uk-form-info uk-width-2-10">
                        <div class="uk-validate-message uk-validate-message-tips" for="name">
                            <em class="uk-validate-message-icon"></em><span class="uk-validate-message-text">标题名称不能超过20个字符</span>
                        </div>
                    </div>
                </div>
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-info uk-width-2-10">
                        <div class="uk-validate-message uk-validate-message-tips" for="logo">
                            <em class="uk-validate-message-icon"></em><span class="uk-validate-message-text">不能为空，图片限1M以内
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-field uk-width-6-10">
                       	<textarea rows="3" name="remark" maxlength="500">${culture.remark}</textarea>
                    </div>
                    <div class="uk-form-info uk-width-2-10">
...
<script type="text/javascript" src="${CONTEXT_PATH}/resources/scripts/admin/culture/add.js"></script>
</body>
</html>