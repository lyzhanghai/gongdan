...
<div class="uk-container">
    <div class="uk-location">
        <ul class="uk-breadcrumb">
            ...
            <li class="active">新增知识类别</li>
        </ul>
    </div>
    <form id="knowledgeTypeForm" class="uk-form" name="knowledgeTypeForm" action="${CONTEXT_PATH}/admin/knowledgetype/add" method="post">
        <fieldset>
            <legend>新增知识类别</legend>
            <div>
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-field uk-width-2-5">
                        <input type="text" name="orderNum" maxlength="10"/>
                    </div>
                    <div class="uk-form-info uk-width-2-5">
                ...
                <div class="uk-form-row">
                    <div class="uk-form-btn uk-width-1-1">
                        <button type="button" class="uk-button uk-button-primary" onclick="saveknowledgeType(this);" data-loading-text="保存中....">保存信息</button>
                        &nbsp;&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript" src="${CONTEXT_PATH}/resources/scripts/admin/knowledgetype/add.js"></script>
</body>
</html>