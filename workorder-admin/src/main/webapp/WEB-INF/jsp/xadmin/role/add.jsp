...
<body>
	<div class="uk-container">
		...
		<form id="roleAddForm" class="uk-form" name="roleAddForm" action="${CONTEXT_PATH}/xadmin/role/add/submit" method="post">
				...
				<div>
					<div class="uk-form-row">
						...
						<div class="uk-form-field uk-width-2-5">
							<input type="text" name="roleName" maxlength="20" value="${roleAddForm.roleName}"/>
						</div>
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-field uk-width-2-5">
							<input type="text" name="roleCode" maxlength="50" value="${roleAddForm.roleCode}"/>
						</div>
						<div class="uk-form-info uk-width-2-5">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-field uk-width-2-5">
							<textarea name="description" rows="3" maxlength="200">${roleAddForm.description}</textarea>
						</div>
						<div class="uk-form-info uk-width-2-5">
    ...
    <script type="text/javascript" src="${CONTEXT_PATH}/resources/scripts/xadmin/role/add.js"></script>
</body>
</html>