...
<body>
	<div class="uk-container">
		...
		<form id="resourceAddForm" class="uk-form" name="resourceAddForm" action="${CONTEXT_PATH}/xadmin/resource/add/submit" method="post">
			...
			<fieldset>
				...
				<div>
					<div class="uk-form-row">
						...
						<div class="uk-form-field uk-width-2-5">
							<div id="resourceSelector" class="uk-dropdownselect" data-uk-dropdownselect>
								<input type="hidden" name="parentResourceId" value="${resourceAddForm.parentResourceId}"/>
								<input type="text" name="parentResourceName" readonly="readonly" value="${resourceAddForm.parentResourceName}"/><i class="uk-icon-caret-down"></i>
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-field uk-width-2-5">
							<input type="text" name="resourceName" maxlength="20" value="${resourceAddForm.resourceName}"/>
						</div>
						<div class="uk-form-info uk-width-2-5">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-field uk-width-2-5">
							<input type="text" name="permissionExpression" maxlength="100" value="${resourceAddForm.permissionExpression}"/>
						</div>
						<div class="uk-form-info uk-width-2-5">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-field uk-width-2-5">
							<select name="actionType" value="${resourceAddForm.actionType}">
	                            <option value="">--请选择--</option>
	                            <c:forEach items="${resourceActionTypes}" var="item">
	                            	<option value="${item.typeCode}" ${resourceAddForm.actionType eq item.typeCode ? 'selected' : ''}>${item.typeName}</option>
	                            </c:forEach>
                            </select>
						</div>
						<div class="uk-form-info uk-width-2-5">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-field uk-width-2-5">
							<textarea name="resourceUrl" rows="3" maxlength="500">${resourceAddForm.resourceUrl}</textarea>
						</div>
						<div class="uk-form-info uk-width-2-5">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-field uk-width-2-5">
							<input type="text" name="siblingsIndex" maxlength="10" value="${resourceAddForm.siblingsIndex}"/>
						</div>
						<div class="uk-form-info uk-width-2-5">
    ...
    <script type="text/javascript" src="${CONTEXT_PATH}/resources/scripts/xadmin/resource/add.js"></script>
</body>
</html>